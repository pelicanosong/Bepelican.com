...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'featured.subtitle': 'Viajes auténticos con comunidades locales — turismo de transformación, a tu ritmo.',
    ...
    'exp.climateLive': 'Clima en el destino ahora',
    'exp.feelsLike': 'Se siente como',
    'exp.airTemp': 'aire',
    'exp.humidity': 'humedad',
    'exp.wind': 'viento',
    'exp.climateCity': 'Ciudad',
    'exp.climateAirTempLabel': 'Temperatura del aire',
    'exp.climateHumidityLabel': 'Humedad',
    'exp.climateWindLabel': 'Viento',
    'exp.climateUpdatedLabel': 'Última actualización',
    'exp.climateVisualHint': 'Ilustración del territorio · clima en tiempo real',
    'exp.climateUpdating': 'Actualizando clima en vivo…',
    'exp.climateUnavailable': 'Clima en vivo no disponible',
    'exp.briseldaDestino': 'Destino clima (Briselda)',
    'exp.climateScenePreset': 'Escena animada',
    'exp.briseldaAuto': 'Detectar automático',
  ...
  en: {
    ...
    'featured.subtitle': 'Authentic journeys with local communities — transformation travel, at your pace.',
    ...
    'exp.climateLive': 'Weather at the destination now',
    'exp.feelsLike': 'Feels like',
    'exp.airTemp': 'air',
    'exp.humidity': 'humidity',
    'exp.wind': 'wind',
    'exp.climateCity': 'City',
    'exp.climateAirTempLabel': 'Air temperature',
    'exp.climateHumidityLabel': 'Humidity',
    'exp.climateWindLabel': 'Wind',
    'exp.climateUpdatedLabel': 'Last updated',
    'exp.climateVisualHint': 'Territory illustration · live weather',
    'exp.climateUpdating': 'Updating live weather…',
    'exp.climateUnavailable': 'Live weather unavailable',
    'exp.briseldaDestino': 'Briselda weather destination',
    'exp.climateScenePreset': 'Animated scene',
    'exp.briseldaAuto': 'Auto-detect',
